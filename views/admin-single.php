...
<form class="ui form" method="post" action="answerme.php">
  ...
  <div class="field">
    <textarea name="answer" placeholder="<?=_('回答');?>"></textarea>
  </div>
  
  <div class="field">
    <div class="ui checkbox">
      <input type="checkbox" id="delete" value="yes" name="delete">
      <label for="delete"><?=_('不回答而是直接删除这个问题');?></label>
    </div>
  </div>
  ...
  <button name="submit" type="submit" class="ui fluid black submit button"><?=_('提交');?></button>
</form>
